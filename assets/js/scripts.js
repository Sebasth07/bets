 ...
 */
 ...
 function reserva() {
   var newReserva = new bootstrap.Modal(document.getElementById('exampleModalFullscreen'));
    newReserva.toggle();
 }

function info() {
  var openCaracter = new bootstrap.Modal(document.getElementById('infoModal'));
    openCaracter.toggle();
}



// var minutos = noUiSlider.create(document.getElementById('sliderMinutos'), {
//   start: [30],
//   step:5,
//   connect: [true, false],
//   tooltips: true,
...
// var salidaHora = noUiSlider.create(document.getElementById('salidaHora'), {
//   start: [9],
//   step:1,
//   connect: [true, false],
//   tooltips: true,
...
// var salidaMinutos = noUiSlider.create(document.getElementById('salidaMinutos'), {
//   start: [30],
//   step:5,
//   connect: [true, false],
//   tooltips: true,
...
jQuery('#reservasFechaIngreso').datepicker();
jQuery('#reservasFechaSalida').datepicker();

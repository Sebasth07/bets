...
L:"ytp-mdx-manual-pairing-popup-dialog",U:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-title",Z:"La funci\u00f3n para conectarse a la\u00a0TV mediante un c\u00f3digo generado en la Web pronto dejar\u00e1 de estar disponible"},{G:"div",L:"ytp-mdx-manual-pairing-popup-buttons",R:[{G:"button",la:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],Z:"M\u00e1s informaci\u00f3n"},{G:"button",la:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],
Z:"Aceptar"}]}]}]});this.u=new g.jO(this,250);this.learnMoreButton=this.ia("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.ia("ytp-mdx-manual-pairing-popup-ok");g.D(this,this.u);this.N(this.learnMoreButton,"click",this.B);this.N(this.okButton,"click",this.C)},P8=function(){g.V.call(this,{G:"div",
L:"ytp-mdx-popup-dialog",U:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-popup-title",Z:"Saliste de tu cuenta"},{G:"div",L:"ytp-mdx-popup-description",Z:"Es posible que los videos que mires se agreguen al historial de reproducciones de la TV, lo que puede influir en las recomendaciones. Para que esto no suceda, presiona \u201cCancelar\u201d y accede a YouTube desde tu computadora."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",R:[{G:"button",la:["ytp-button",
"ytp-mdx-privacy-popup-cancel"],Z:"Cancelar"},{G:"button",la:["ytp-button","ytp-mdx-privacy-popup-confirm"],Z:"Confirmar"}]}]}]});this.u=new g.jO(this,250);this.cancelButton=this.ia("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.ia("ytp-mdx-privacy-popup-confirm");g.D(this,this.u);this.N(this.cancelButton,"click",this.B);this.N(this.confirmButton,"click",this.C)},Q8=function(a){g.V.call(this,{G:"div",
...
c=g.U(b,128)?g.KL("Error en $RECEIVER_NAME",c):b.Gb()||g.U(b,4)?g.KL("Reproduciendo en $RECEIVER_NAME",c):g.KL("Conectado a $RECEIVER_NAME",c);a.za("statustext",c);a.u.show()}else a.u.hide()},R8=function(a,b){g.vX.call(this,"Reproducir en",0,a,b);
...
this.Qh={key:i6(),name:"Esta computadora"};this.Kg=null;this.subscriptions=[];this.Tz=this.yb=null;this.Dl=[this.Qh];this.Hk=this.Qh;this.Lc=new g.HM(64);this.oE=0;this.Fe=-1;this.po=null;this.xr=this.Fu=!1;this.Um=this.Ro=null;if(!g.KD(this.player.T())){a=this.player;var b=g.yT(a);b&&(b=b.Pk())&&(b=new R8(a,b),g.D(this,b));b=new Q8(a);g.D(this,b);g.xP(a,b.element,4);this.Ro=new P8;g.D(this,this.Ro);g.xP(a,this.Ro.element,4);g.Q(this.player.T().experiments,"pair_servlet_deprecation_warning_enabled")&&
...
R8.prototype.Uh=function(a){return"cast-selector-receiver"===a?"Transmitir\u2026":this.Dl[a].name};
